                        ...
                        <div class="wrapper best  ">
                            ...
                            <div class="row  my-1">
                                <div class="col-12 buyNow_part2 d-flex justify-content-center ">
                                    ...
                                    <div class="px-1">
                                        <?php echo $vendor->getPriceAdult(); ?> €/ <span
                                                class="perperson">  <?php echo $vendor->getForHowManyPersonsIsString($menu[183], $menu[184], $menu[185], $menu[186]); ?> </span>
                                    </div>
                                </div>
                            </div>
                            <div class="row   my-1 ">
                                <div class="col-12  d-flex justify-content-between  text-black">
                                    ...
                                    <div>
                                        <?php echo $menu[48]; ?> <span
                                                class="exprice"><?php echo $vendor->getOriginalPrice(); ?> € </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 text-start text-success  ">
                                    <?php if ($_SESSION['languageId'] == 1) { ?>
                                        Χρησιμοποιώντας το <span class="vpicon">VP </span>Voucher,
                                                                                          εξοικονομείτε<span
                                                class="vpicon"> <?php echo $vendor->getDiscount(); ?>%</span>  από την αρχική τιμή
                                    <?php } else { ?>
                                        Save <span
                                                class="vpicon"> <?php echo $vendor->getDiscount(); ?>%</span>  pp on the initial price
                                        <br>
                                        ...
                                        <div class="collapse " id="collapse<?php echo $vendor->getId(); ?>">
                                            <div class="text-center my-0">
                                                <p class="my-1"> <?php echo $menu[223] ?> <?php echo($totalToPay + $vendor->getPriceAdult()); ?>
                                                    €/ <span
                                                            class="perperson">  <?php echo $vendor->getForHowManyPersonsIsString($menu[183], $menu[184], $menu[185], $menu[186]); ?> </span>
                                                    <br>(<b class="vpicon"> VP</b> Voucher + <?php echo $menu[224] ?>)
                                                </p>
                                            </div>
                                            <div>
