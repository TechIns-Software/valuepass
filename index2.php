				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="logo-nav">
								<a href="index.html">
									<!-- <img src="images/logo.png" alt="Company logo" /> -->VALUE PASS
								</a>
							</div>
                            <!--End Logo -->
       ...
       <div class="container">
           <div class="row">
               ...
               <div class="col-md-6 col-sm-6 col-xs-6">
                   <div class="copyright"><p>Copyright © All Rights reserved by: <a target="_blank" href="https://www.insurance-agent-tools.com">TechIns</a>
                 </p></div>
               </div>
               <!--End copyright-->
