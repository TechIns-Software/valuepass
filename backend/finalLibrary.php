...
function calculatePriceCart($conn, $arrayVouchers)
{
    ...
    if (count($arrayVouchers) == 1) {
        if ($canOrder) {
            $messageModal = $menu[164] . '  ' . count($arrayVouchers) . ' ' . $menu[165] . ' ' . $menu[166] . ' 3 ' . $menu[167] . ' 
...
function getTemplateVoucher($package = [], $adults = 0, $children = 0, $infants = 0, $idVendor = 0, $nameVendor = '', $numberOfPackages = 1)
{
    ...
    if ($_SESSION["languageId"] == 2) {
        ...
        $message13 = "Μπορείτε να ακυρώσετε τη δραστηριότητα μέχρι τις  ";
        $message14 = "σύμφωνα με την πολιτική ακύρωσης του προμηθευτή";
        $message15 = "Τα VP Vouchers δεν παρέχουν τη δυνατότητα ακύρωσης ή επιστροφής χρημάτων, ωστόσο πάντα προσπαθούμε να σας προσφέρουμε τις καλύτερες εναλλακτικές λύσεις σύμφωνα με τις δυνατότητες των παρόχων των δραστηριοτήτων που προωθούμε, σε οποιαδήποτε περίπτωση μη πραγματοποίησης της δραστηριότητας από υπαιτιότητα του παρόχου.";
